...
export const USERROUTES: RouteInfo[] = [ 
 // { path: '/log', title: 'Logs', icon: 'update', class: '', claim: "GetLogDtoQuery" },
  { path: '/birim', title: 'Birim', icon: 'update', class: '', claim: "GetBirimQuery" },
  { path: '/birimagac', title: 'Birim Ağaç', icon: 'update', class: '', claim: "GetBirimAgacQuery" },
  { path: '/birimagackullanicirol', title: 'Birim Ağaç Kullanıcı Rol', icon: 'update', class: '', claim: "GetBirimAgacQuery" },
  { path: '/proje', title: 'Proje', icon: 'update', class: '', claim: "GetProjeQuery" },
];
