...
import { BirimComponent } from 'app/core/components/app/birim/birim.component';
import { BirimAgacComponent } from 'app/core/components/app/birimAgac/birimAgac.component';
import { BirimAgacKullaniciRolComponent } from 'app/core/components/app/birimAgacKullaniciRol/birimAgacKullaniciRol.component';
import { ProjeComponent } from 'app/core/components/app/proje/proje.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'birim',          component: BirimComponent,canActivate:[LoginGuard]},
    { path: 'birim',          component: BirimComponent,canActivate:[LoginGuard]},
    { path: 'birimagac',      component: BirimAgacComponent,canActivate:[LoginGuard]},
    { path: 'birimagackullanicirol',      component: BirimAgacKullaniciRolComponent,canActivate:[LoginGuard]},
    { path: 'proje',          component: ProjeComponent,canActivate:[LoginGuard]}
];
