...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRolYetkiIslevObjeRepository, RolYetkiIslevObjeRepository>();
            services.AddTransient<IRolMenuIslevObjeRepository, RolMenuIslevObjeRepository>();
            services.AddTransient<IRolRepository, RolRepository>();
            services.AddTransient<IProjeRepository, ProjeRepository>();
            services.AddTransient<IObjeRepository, ObjeRepository>();
            services.AddTransient<IMenuRepository, MenuRepository>();
            services.AddTransient<IKullaniciYetkiIslevObjeRepository, KullaniciYetkiIslevObjeRepository>();
            services.AddTransient<IKullaniciYetkiIslevEngelRepository, KullaniciYetkiIslevEngelRepository>();
            services.AddTransient<IKullaniciRolRepository, KullaniciRolRepository>();
            services.AddTransient<IKullaniciMenuIslevObjeRepository, KullaniciMenuIslevObjeRepository>();
            services.AddTransient<IKullaniciMenuIslevEngelRepository, KullaniciMenuIslevEngelRepository>();
            services.AddTransient<IKod_RolTipRepository, Kod_RolTipRepository>();
            services.AddTransient<IKod_RolSeviyeRepository, Kod_RolSeviyeRepository>();
            services.AddTransient<IKod_BirlikTipRepository, Kod_BirlikTipRepository>();
            services.AddTransient<IIslevRepository, IslevRepository>();
            services.AddTransient<IBirimYetkiIslevObjeRepository, BirimYetkiIslevObjeRepository>();
            services.AddTransient<IBirimAgacKullaniciRolRepository, BirimAgacKullaniciRolRepository>();
            services.AddTransient<IBirimAgacRepository, BirimAgacRepository>();
